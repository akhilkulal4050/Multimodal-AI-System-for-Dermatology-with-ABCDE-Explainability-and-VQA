...
from typing import Any, List, Optional, Tuple, Union, Dict, Set, Callable
from transformers.models.clip.modeling_clip import (Callable, torch, nn, init, ACT2FN, ALL_ATTENTION_FUNCTIONS, Unpack, TransformersKwargs, torch_int, CLIPTextConfig, CLIPVisionConfig)
...
def CLIPVisionEmbeddings_forward(self, pixel_values: torch.FloatTensor, interpolate_pos_encoding=False) -> torch.Tensor:
...
class CLIPVisionEmbeddings(nn.Module):
    ...
    def forward(self, pixel_values: torch.FloatTensor, interpolate_pos_encoding=False) -> torch.Tensor:
        return CLIPVisionEmbeddings_forward(self, pixel_values=pixel_values, interpolate_pos_encoding=interpolate_pos_encoding)
...
class CLIPTextEmbeddings(nn.Module):
    ...
    def forward(
        ...
        return CLIPTextEmbeddings_forward(self, input_ids=input_ids, position_ids=position_ids, inputs_embeds=inputs_embeds)
...
class CLIPAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        return CLIPAttention_forward(self, hidden_states=hidden_states, attention_mask=attention_mask, **kwargs)


@torch.compile(fullgraph = False, dynamic = True, options = torch_compile_options)
def CLIPMLP_forward(self, hidden_states: torch.Tensor) -> torch.Tensor:
...
class CLIPMLP(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor) -> torch.Tensor:
        return CLIPMLP_forward(self, hidden_states=hidden_states)
